...
DEBUG = True  # str2bool(os.getenv('DEBUG', 'False'))
...
os.environ['DJANGO_LIVE_TEST_SERVER_ADDRESS'] = 'localhost:4040'

SECRET_KEY = os.getenv('SECRET_KEY', "hk(35@i-4(=uykhy43j9aoub+!28n)1b-1u3bvr$51!b@dacmt")
...
GUARDIAN_GET_INIT_ANONYMOUS_USER = os.getenv('GUARDIAN_GET_INIT_ANONYMOUS_USER',
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        # },
        'metadata:main': {
            'identification_title': 'cartoview Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, cartoview',
