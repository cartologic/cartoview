...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppTag'
        db.create_table(u'app_manager_apptag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'app_manager', ['AppTag'])

        # Adding model 'App'
        db.create_table(u'app_manager_app', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('installed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Profile'], null=True, blank=True)),
            ('single_instance', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('order', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('owner_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('help_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('is_suspended', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
            ('app_img_url', self.gf('django.db.models.fields.TextField')(max_length=1000)),
            ('in_menu', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True)),
            ('admin_only', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
        ...
        db.send_create_signal(u'app_manager', ['App'])

        # Adding M2M table for field tags on 'App'
        m2m_table_name = db.shorten_name(u'app_manager_app_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('app', models.ForeignKey(orm[u'app_manager.app'], null=False)),
            ('apptag', models.ForeignKey(orm[u'app_manager.apptag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['app_id', 'apptag_id'])

        # Adding model 'AppInstance'
        db.create_table(u'app_manager_appinstance', (
            ...
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app_manager.App'], null=True, blank=True)),
        ))
        db.send_create_signal(u'app_manager', ['AppInstance'])


    def backwards(self, orm):
        # Deleting model 'AppTag'
        db.delete_table(u'app_manager_apptag')

        # Deleting model 'App'
        db.delete_table(u'app_manager_app')

        # Removing M2M table for field tags on 'App'
        db.delete_table(db.shorten_name(u'app_manager_app_tags'))

        # Deleting model 'AppInstance'
        db.delete_table(u'app_manager_appinstance')
    ...
    models = {
        u'app_manager.app': {
            ...
            'app_img_url': ('django.db.models.fields.TextField', [], {'max_length': '1000'}),
            ...
            'help_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_menu': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
            'installed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['people.Profile']", 'null': 'True', 'blank': 'True'}),
            'is_suspended': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            ...
            'owner_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['app_manager.AppTag']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        u'app_manager.appinstance': {
            'Meta': {'object_name': 'AppInstance', '_ormbases': [u'base.ResourceBase']},
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app_manager.App']", 'null': 'True', 'blank': 'True'}),
            u'resourcebase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['base.ResourceBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'app_manager.apptag': {
