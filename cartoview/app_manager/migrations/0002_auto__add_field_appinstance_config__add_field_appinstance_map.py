...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppInstance.config'
        db.add_column(u'app_manager_appinstance', 'config',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppInstance.map'
        db.add_column(u'app_manager_appinstance', 'map',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maps.Map'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppInstance.config'
        db.delete_column(u'app_manager_appinstance', 'config')

        # Deleting field 'AppInstance.map'
        db.delete_column(u'app_manager_appinstance', 'map_id')
    ...
    models = {
        ...
        u'maps.map': {
            ...
            'featuredurl': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
