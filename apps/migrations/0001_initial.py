# Generated by Django 2.1.3 on 2019-02-18 17:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='app',
            name='category',
            field=models.ManyToManyField(related_name='apps', to='apps.AppType'),
        ),
        migrations.AddField(
            model_name='app',
            name='installed_by',
        ...
        migrations.AddField(
            model_name='app',
            name='store',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.AppStore'),
        ),
        migrations.AddField(
            model_name='app',
            name='tags',
