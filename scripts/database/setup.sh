...
psql -U postgres -c "create user cartoview -d -s"
...
psql -U postgres -c "create database -O cartoview cartoview"
psql -U postgres -c "create database -T template_postgis -O cartoview cartoview_data"